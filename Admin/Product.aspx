                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:TextBox ID="txtQuantity" runat="server" CssClass="form-control"
                                                            placeholder="Enter Quantity Price"></asp:TextBox>
                                                ...
                                                <%--<div class="form-group">
                                                    ...
                                                    <div>
                                                        <asp:DropDownList ID="ddlCategories" runat="server" CssClass="form-control"
                                                            DataTextField="Name" DataValueField="CategoryId" DataSourceID="SqlDataSource2"
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:FoodieDBConnectionString3 %>" ProviderName="<%$ ConnectionStrings:FoodieDBConnectionString3.ProviderName %>" SelectCommand="SELECT [CategoryId], [Name] FROM [Categories]"></asp:SqlDataSource>
<%--                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                            ConnectionString="<%$ ConnectionStrings:FoodieDBConnectionString2 %>" 
                                                            ProviderName="<%$ ConnectionStrings:FoodieDBConnectionString2.ProviderName %>" 
